...
export const NAV = [
  ...
  { path: '/hybrid', label: 'Hybrid Pipeline', icon: 'Sparkles', group: 'Run' },
  { path: '/cockpit', label: 'Agent Cockpit', icon: 'Cpu', group: 'Run' },
  { path: '/compute', label: 'Compute Center', icon: 'Cpu', group: 'Compute & Models' },
  { path: '/model-lab', label: 'Data & Model Lab', icon: 'FlaskConical', group: 'Compute & Models' },
  { path: '/active-learning', label: 'Active Learning', icon: 'Radar', group: 'Compute & Models' },
  { path: '/rediscovery', label: 'Rediscovery', icon: 'Target', group: 'Analysis' },
  { path: '/optimization-loop', label: 'Optimization Loop', icon: 'GitBranch', group: 'Analysis' },
  { path: '/llm', label: 'LLM Router', icon: 'BrainCircuit', group: 'System' },
