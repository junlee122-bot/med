...
def build_manifest(run_id: str) -> dict[str, Any]:
    ...
    manifest = {
        ...
        "evidence_count": db.count("evidence_items", project_id, run_id),
        "target_count": db.count("target_candidates", project_id, run_id),
        "molecule_count": db.count("molecule_candidates", project_id, run_id),
        "agent_run_count": db.count("agent_runs", project_id, run_id),
        "revision_count": db.count("revision_events", project_id, run_id),
